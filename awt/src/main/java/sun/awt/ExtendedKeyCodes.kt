...
object ExtendedKeyCodes {
    ...
    private val regularKeyCodesMap = HashMap<Int, Int>(98, 1.0f)
    ...
    private val extendedKeyCodesSet = HashSet<Int>(496, 1.0f)
    fun getExtendedKeyCodeForChar(c: Int): Int {
        var c = c
        if (regularKeyCodesMap.containsKey(c)) {
            return if (regularKeyCodesMap.containsKey(c)) {
                regularKeyCodesMap[c]!!
            } else regularKeyCodesMap[c]!!
        }
        c += 0x01000000
        if (extendedKeyCodesSet.contains(c)) {
            return c
        } else if (extendedKeyCodesSet.contains(c)) {
            return c
        }
    ...
    init {
        regularKeyCodesMap[0x08] = KeyEvent.VK_BACK_SPACE
        regularKeyCodesMap[0x09] = KeyEvent.VK_TAB
        regularKeyCodesMap[0x0a] = KeyEvent.VK_ENTER
        regularKeyCodesMap[0x1B] = KeyEvent.VK_ESCAPE
        regularKeyCodesMap[0x20AC] = KeyEvent.VK_EURO_SIGN
        regularKeyCodesMap[0x20] = KeyEvent.VK_SPACE
        regularKeyCodesMap[0x21] = KeyEvent.VK_EXCLAMATION_MARK
        regularKeyCodesMap[0x22] = KeyEvent.VK_QUOTEDBL
        regularKeyCodesMap[0x23] = KeyEvent.VK_NUMBER_SIGN
        regularKeyCodesMap[0x24] = KeyEvent.VK_DOLLAR
        regularKeyCodesMap[0x26] = KeyEvent.VK_AMPERSAND
        regularKeyCodesMap[0x27] = KeyEvent.VK_QUOTE
        regularKeyCodesMap[0x28] = KeyEvent.VK_LEFT_PARENTHESIS
        regularKeyCodesMap[0x29] = KeyEvent.VK_RIGHT_PARENTHESIS
        regularKeyCodesMap[0x2A] = KeyEvent.VK_ASTERISK
        regularKeyCodesMap[0x2B] = KeyEvent.VK_PLUS
        regularKeyCodesMap[0x2C] = KeyEvent.VK_COMMA
        regularKeyCodesMap[0x2D] = KeyEvent.VK_MINUS
        regularKeyCodesMap[0x2E] = KeyEvent.VK_PERIOD
        regularKeyCodesMap[0x2F] = KeyEvent.VK_SLASH
        regularKeyCodesMap[0x30] = KeyEvent.VK_0
        regularKeyCodesMap[0x31] = KeyEvent.VK_1
        regularKeyCodesMap[0x32] = KeyEvent.VK_2
        regularKeyCodesMap[0x33] = KeyEvent.VK_3
        regularKeyCodesMap[0x34] = KeyEvent.VK_4
        regularKeyCodesMap[0x35] = KeyEvent.VK_5
        regularKeyCodesMap[0x36] = KeyEvent.VK_6
        regularKeyCodesMap[0x37] = KeyEvent.VK_7
        regularKeyCodesMap[0x38] = KeyEvent.VK_8
        regularKeyCodesMap[0x39] = KeyEvent.VK_9
        regularKeyCodesMap[0x3A] = KeyEvent.VK_COLON
        regularKeyCodesMap[0x3B] = KeyEvent.VK_SEMICOLON
        regularKeyCodesMap[0x3C] = KeyEvent.VK_LESS
        regularKeyCodesMap[0x3D] = KeyEvent.VK_EQUALS
        regularKeyCodesMap[0x3E] = KeyEvent.VK_GREATER
        regularKeyCodesMap[0x40] = KeyEvent.VK_AT
        regularKeyCodesMap[0x41] = KeyEvent.VK_A
        regularKeyCodesMap[0x42] = KeyEvent.VK_B
        regularKeyCodesMap[0x43] = KeyEvent.VK_C
        regularKeyCodesMap[0x44] = KeyEvent.VK_D
        regularKeyCodesMap[0x45] = KeyEvent.VK_E
        regularKeyCodesMap[0x46] = KeyEvent.VK_F
        regularKeyCodesMap[0x47] = KeyEvent.VK_G
        regularKeyCodesMap[0x48] = KeyEvent.VK_H
        regularKeyCodesMap[0x49] = KeyEvent.VK_I
        regularKeyCodesMap[0x4A] = KeyEvent.VK_J
        regularKeyCodesMap[0x4B] = KeyEvent.VK_K
        regularKeyCodesMap[0x4C] = KeyEvent.VK_L
        regularKeyCodesMap[0x4D] = KeyEvent.VK_M
        regularKeyCodesMap[0x4E] = KeyEvent.VK_N
        regularKeyCodesMap[0x4F] = KeyEvent.VK_O
        regularKeyCodesMap[0x50] = KeyEvent.VK_P
        regularKeyCodesMap[0x51] = KeyEvent.VK_Q
        regularKeyCodesMap[0x52] = KeyEvent.VK_R
        regularKeyCodesMap[0x53] = KeyEvent.VK_S
        regularKeyCodesMap[0x54] = KeyEvent.VK_T
        regularKeyCodesMap[0x55] = KeyEvent.VK_U
        regularKeyCodesMap[0x56] = KeyEvent.VK_V
        regularKeyCodesMap[0x57] = KeyEvent.VK_W
        regularKeyCodesMap[0x58] = KeyEvent.VK_X
        regularKeyCodesMap[0x59] = KeyEvent.VK_Y
        regularKeyCodesMap[0x5A] = KeyEvent.VK_Z
        regularKeyCodesMap[0x5B] = KeyEvent.VK_OPEN_BRACKET
        regularKeyCodesMap[0x5C] = KeyEvent.VK_BACK_SLASH
        regularKeyCodesMap[0x5D] = KeyEvent.VK_CLOSE_BRACKET
        regularKeyCodesMap[0x5E] = KeyEvent.VK_CIRCUMFLEX
        regularKeyCodesMap[0x5F] = KeyEvent.VK_UNDERSCORE
        regularKeyCodesMap[0x60] = KeyEvent.VK_BACK_QUOTE
        regularKeyCodesMap[0x61] = KeyEvent.VK_A
        regularKeyCodesMap[0x62] = KeyEvent.VK_B
        regularKeyCodesMap[0x63] = KeyEvent.VK_C
        regularKeyCodesMap[0x64] = KeyEvent.VK_D
        regularKeyCodesMap[0x65] = KeyEvent.VK_E
        regularKeyCodesMap[0x66] = KeyEvent.VK_F
        regularKeyCodesMap[0x67] = KeyEvent.VK_G
        regularKeyCodesMap[0x68] = KeyEvent.VK_H
        regularKeyCodesMap[0x69] = KeyEvent.VK_I
        regularKeyCodesMap[0x6A] = KeyEvent.VK_J
        regularKeyCodesMap[0x6B] = KeyEvent.VK_K
        regularKeyCodesMap[0x6C] = KeyEvent.VK_L
        regularKeyCodesMap[0x6D] = KeyEvent.VK_M
        regularKeyCodesMap[0x6E] = KeyEvent.VK_N
        regularKeyCodesMap[0x6F] = KeyEvent.VK_O
        regularKeyCodesMap[0x70] = KeyEvent.VK_P
        regularKeyCodesMap[0x71] = KeyEvent.VK_Q
        regularKeyCodesMap[0x72] = KeyEvent.VK_R
        regularKeyCodesMap[0x73] = KeyEvent.VK_S
        regularKeyCodesMap[0x74] = KeyEvent.VK_T
        regularKeyCodesMap[0x75] = KeyEvent.VK_U
        regularKeyCodesMap[0x76] = KeyEvent.VK_V
        regularKeyCodesMap[0x77] = KeyEvent.VK_W
        regularKeyCodesMap[0x78] = KeyEvent.VK_X
        regularKeyCodesMap[0x79] = KeyEvent.VK_Y
        regularKeyCodesMap[0x7A] = KeyEvent.VK_Z
        regularKeyCodesMap[0x7B] = KeyEvent.VK_BRACELEFT
        regularKeyCodesMap[0x7D] = KeyEvent.VK_BRACERIGHT
        regularKeyCodesMap[0x7F] = KeyEvent.VK_DELETE
        regularKeyCodesMap[0xA1] = KeyEvent.VK_INVERTED_EXCLAMATION_MARK
