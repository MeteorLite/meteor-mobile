...
@ObfuscatedName("org/json/osrs.JSONArray")
public class JSONArray {
   ...
   public JSONArray(JSONTokener var1) throws JSONException {
      ...
      if (var2 == '[') {
         ...
         if (var2 != '(') {
            throw var1.syntaxError("A osrs.JSONArray text must start with '['");
         }
   ...
   @ObfuscatedName("put")
   @ObfuscatedSignature(
      descriptor = "(Ljava/lang/Object;)Lorg/json/osrs.JSONArray;"
   )
   ...
   @ObfuscatedSignature(
      descriptor = "(I)Lorg/json/osrs.JSONObject;"
   )
   public JSONObject getJSONObject(int var1) throws JSONException {
      ...
      if (var2 instanceof JSONObject) {
         ...
         throw new JSONException("JSONArray[" + var1 + "] is not a osrs.JSONObject.");
      }
   }
