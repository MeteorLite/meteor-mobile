...
public class class167 {
   ...
   @ObfuscatedName("ay")
   @ObfuscatedSignature(
      descriptor = "(Lorg/json/osrs.JSONArray;Leb;I)V",
   ...
   @ObfuscatedName("am")
   @ObfuscatedSignature(
      descriptor = "(Lorg/json/osrs.JSONArray;I)V",
   ...
   @ObfuscatedName("az")
   @ObfuscatedSignature(
      descriptor = "(Lorg/json/osrs.JSONObject;I)V",
   ...
   @ObfuscatedName("ae")
   @ObfuscatedSignature(
      descriptor = "(Lorg/json/osrs.JSONObject;B)V",
      garbageValue = "7"
   )
