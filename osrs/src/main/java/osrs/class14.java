...
public class class14 {
               ...
               try {
                  ...
                  if (var30) {
                     ...
                     if (!var9 && var2 > 0 && var10 >= var2) {
                        class364.RunException_sendStackTrace("Warning: osrs.Script " + var4.field793 + " finished at op count " + var10 + " of max " + var1, (Throwable)null);
                     }
   ...
   public static void setLoginIndex(int var0) {
