   ...
   public static void RunException_sendStackTrace(String var0, Throwable var1) {
      if (var1 != null) {
         ...
         try {
            ...
            URL var3 = new URL(new URL(Paramaters.getCodeBase()), "clienterror.ws?cv=" + RunException.RunException_revision + "&cs=" + class199.field1633 + "&u=" + RunException.localPlayerName + "&v1=" + TaskHandler.javaVendor + "&v2=" + TaskHandler.javaVersion + "&ct=" + class458.field3923 + "&e=" + var2);
