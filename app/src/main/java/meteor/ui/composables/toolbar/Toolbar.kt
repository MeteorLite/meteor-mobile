...
val width = mutableStateOf(Main.meteorConfig.toolbarWidth.get()!!)


@Composable
fun ToolbarPanel() {
    return Column(modifier = Modifier.width(width.value.dp).fillMaxHeight().background(surface), horizontalAlignment = Alignment.CenterHorizontally) {
